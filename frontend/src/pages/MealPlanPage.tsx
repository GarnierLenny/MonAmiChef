        ...
        <div className="flex-1 overflow-y-auto px-4 py-6">
          <div className="max-w-sm mx-auto space-y-4">
            {MEAL_SLOTS.map((meal) => {
              ...
              return (
                <Card key={meal} className="border-2 border-gray-200 rounded-2xl">
                    ...
                    <div className="text-center">
                      ...
                      {assignedMeal ? (
                        <div className="space-y-2">
                          <div className="text-4xl mb-2">{assignedMeal.image}</div>
                          <div className="text-center">
                        ...
                        <div className="py-8">
                          <div className="w-16 h-16 mx-auto mb-3 border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center">
