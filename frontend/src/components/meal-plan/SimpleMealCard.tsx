      ...
      {meal ? (
        <div className="space-y-3">
          ...
          <div className="flex items-start justify-between">
            ...
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ml-3 flex-shrink-0 ${getGradeStyles(meal.grade)}`}
            >
              {meal.grade}
            </div>
          </div>
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="font-semibold text-xl text-gray-900">{meal.calories} cal</span>
          </div>
